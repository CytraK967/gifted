...
OWNER_NAME: process.env.OWNER_NAME || "DRIPPY 𝐓𝐄𝐂𝐇", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "DRIPPY𝐓𝐄𝐂𝐇", // Added // Input Yours custom...
